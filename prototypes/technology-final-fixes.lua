...
if mods["bobassembly"] then
  add_tiny_unlock("automation-4", "tiny-bob-assembling-machine-4")
  add_tiny_unlock("automation-5", "tiny-bob-assembling-machine-5")
  add_tiny_unlock("automation-6", "tiny-bob-assembling-machine-6")
end
